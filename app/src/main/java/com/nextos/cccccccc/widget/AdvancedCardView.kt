...
//        addBackgroundRectF(shadow.mask)
    ...
    private fun initBackgroundPaint() {
        ...
        if (background_ColorType == ColorType.Gradient_Linear) background_Paint.shader = getLinearShader(background_Gradient_Colors, background_Gradient_Angle)
        else if (background_ColorType == ColorType.Gradient_Radial) background_Paint.shader = getRadialShader(background_Gradient_Colors, background_Gradient_OffCenter_X, background_Gradient_OffCenter_Y)
        else if (background_ColorType == ColorType.Gradient_Sweep) background_Paint.shader = getSweepShader(background_Gradient_Colors, background_Gradient_Angle, background_Gradient_OffCenter_X, background_Gradient_OffCenter_Y)
    }
    ...
    private fun initStrokePaint() {
        ...
        if (stroke_ColorType == ColorType.Gradient_Linear) stroke_Paint.shader = getLinearShader(stroke_Gradient_Colors, stroke_Gradient_Angle)
        else if (stroke_ColorType == ColorType.Gradient_Sweep) stroke_Paint.shader = getSweepShader(stroke_Gradient_Colors, stroke_Gradient_Angle, stroke_Gradient_OffCenter_X, stroke_Gradient_OffCenter_Y)
    }
